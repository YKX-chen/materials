	...
	<view class="content">
		...
		<view class="detail" v-if="click==0">
			...
			<view class="name">
				...
				<view v-if=" GetInfoByIdData.F_Status==3">作废</view>
			</view>
			<view class="name">
				<view>客户名称</view>
			...
			<view class="name">
				...
				<view class="textmax">{{ GetInfoByIdData.cutAddress }}</view>
			</view>
			<view class="name">
				<view>联系人</view>
				<view>{{ GetInfoByIdData.cutContacts }}</view>
			</view>
			<view class="name">
				<view>联系电话</view>
				<view>{{ GetInfoByIdData.cutMoiblePhone }}</view>
			</view>
			<view class="name">
				<view>销售单号</view>
			...
			<view class="name">
				<view>销售项目</view>
				<view v-if="GetInfoByIdData.proCode == null">{{ GetInfoByIdData.proName }}</view>
				<view v-if="GetInfoByIdData.proCode != null">{{GetInfoByIdData.proCode}}-{{ GetInfoByIdData.proName }}</view>
			</view>
			<view class="name">
				<view>应收日期</view>
		...
		<view class="detail" v-if="click==1">
			...
			<view class="listson" v-for="(item,index) in GetBillList" :key="index">
				...
				<view class="sonson" v-if="item.F_CostMoney != null">¥{{item.F_CostMoney}}元</view>
				<view class="sonson" v-if="item.F_CostMoney == null">¥ 0元</view>
			</view>
		</view>
