	...
	<view class="content">
		...
		<view class="detail">
			<view class="bianju">
				...
				<view class="name">
					<view>付款金额<span style="color: red; margin-left: 8rpx">*</span></view>
				...
				<view class="name">
					<view>付款日期<span style="color: red; margin-left: 8rpx">*</span></view>
				...
				<view class="name" v-if="F_PayMethod==2">
					<view>支付账户<span style="color: red; margin-left: 8rpx">*</span></view>
...
<script>
	...
	export default {
		...
		methods: {
			// 付款金额
			moneyes() {
				console.log(this.purchaseForm.F_PayMoney, '付款金额')
			...
			PaySubmit(Data) {
				uni.request({
					url: this.url + "/WebApiInterface/Payment/PaySubmit",
					method: "POST",
					data: Data,
					success: (res) => {
			...
			submit() {
				...
				var Form = {
					"F_VoucherId": this.$store.paymentid, //账单表ID
					"F_PayMoney": this.purchaseForm.F_PayMoney, //付款金额
					"F_Date": this.beginDate, //付款日期
					"F_PayMethod": this.F_PayMethod, //支付方式(1.现金 2.转账) 
					"F_PayAccount": this.purchaseForm.F_PayAccount, //付款支付账户
				...
				if (this.F_PayMethod == '1') {
					...
					if (
						this.purchaseForm.F_PayMoney == null | !Form.F_Date | !Form.F_PayMethod | !Form.F_PayAccount | !
						Form.F_PayBankDeposit |
